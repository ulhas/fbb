...
struct ProfileHeroCard: View {
        ...
        .background(
            LinearGradient(
                colors: [
                    ...
                    Color.fbbTealTint.opacity(0.30),
                ],
        ...
        ZStack {
            ...
            if tier != .free {
                Image(systemName: "sparkles")
                    ...
                    .background(Color.fbbTeal, in: Circle())
                    .overlay(
    ...
    private var tierBadge: some View {
        ...
        .foregroundStyle(tier == .free ? Color.inkSecondary : Color.fbbTeal)
        .padding(.vertical, 2)
        .padding(.horizontal, 6)
        .background(
            (tier == .free ? Color.inkMuted.opacity(0.15) : Color.fbbTealTint.opacity(0.6)),
            in: Capsule()
        )
    }
