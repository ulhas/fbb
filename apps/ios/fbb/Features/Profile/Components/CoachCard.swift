    ...
    var body: some View {
        VStack(alignment: .leading, spacing: Spacing.md) {
            ...
            Button(action: onMessage) {
                ...
                .background(Color.fbbTealTint.opacity(0.55), in: RoundedRectangle(cornerRadius: 12, style: .continuous))
            }
            .buttonStyle(.plain)
            ...
            VStack(alignment: .leading, spacing: Spacing.xs) {
                ...
                Button(action: onChangePersonality) {
                    ...
                    .background(Color.fbbTealTint.opacity(0.45), in: Capsule())
                }
                .buttonStyle(.plain)
            }
        }
