...
struct TrackWorkoutCard: View {
    ...
    private var workoutBody: some View {
        VStack(alignment: .leading, spacing: Spacing.sm) {
            // Day title intentionally omitted — for the parsed FBB tracks
    ...
    private var kindLabelTint: Color {
        ...
        case .workout: return .fbbOrange
        default:       return .fbbTeal
        }
    }
    ...
    private var kindLabelBackground: Color {
        ...
        case .workout: return .fbbOrangeTint.opacity(0.55)
        default:       return .fbbTealTint.opacity(0.55)
        }
    }
    ...
    private var familyTint: Color {
        ...
        case .pumpCondition, .hybridRunning, .minimalist:  return .fbbTeal
