...
/// `BYOWWorkoutKitCore` dependency.
@MainActor
final class LiveActivityBridge {
    static var shared: LiveActivityBridge?

    static let togglePauseNotification = Notification.Name("byow.liveActivity.togglePause")
    static let logSetNotification      = Notification.Name("byow.liveActivity.logSet")
