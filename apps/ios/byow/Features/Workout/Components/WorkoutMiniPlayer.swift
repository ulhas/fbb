...
struct WorkoutMiniPlayer: View {
    ...
    /// Destructive end-of-workout control. Saturated red (`Color.byowStop`
    /// asset) matched in punch to `Color.byowOrange`, so the two
    ...
    private var secondaryColor: Color {
        session.isPaused ? Color.byowOrange : Color.inkSecondary
    }
}
